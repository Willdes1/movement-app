    ...
    <div>
      ...
      <Panel style={{ padding: 20, marginBottom: 24, border: `1px solid ${C.accentBorder}`, background: `linear-gradient(135deg, rgba(59,130,246,0.04) 0%, rgba(167,139,250,0.04) 100%)` }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
          ...
          <Label color={C.accent}>Movement Intelligence Engine — MIE</Label>
        </div>
      ...
      <Panel style={{ padding: 20 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          {[
            { emoji: '🧠', title: 'Movement Intelligence Engine — Not a Feature', desc: 'The MIE is a multi-agent RAG pipeline. A council of specialized AI agents — each grounded in a curated Domain Knowledge Store — collaborates on every plan. No competitor has this architecture.' },
