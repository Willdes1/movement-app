...
const STATIC_TERMS: Entry[] = [
  ...
  { id: 's-t6', category: 'term', our_name: null, industry_name: 'RAG (Retrieval-Augmented Generation)', definition: 'An AI architecture that grounds a language model\'s responses in a curated external knowledge store (retrieved at query time) rather than relying on training data alone. Produces more accurate, specific, and verifiable outputs.', notes: 'Our APIE uses pgvector for semantic search over the Domain Knowledge Store.', isStatic: true },
  { id: 's-t7', category: 'term', our_name: null, industry_name: 'Agentic Pipeline', definition: 'An AI system where multiple specialized agents work in sequence or parallel, each with a defined role, passing context between them to produce a unified output. More powerful than a single-model prompt.', notes: 'Our APIE has 9 specialized agents including one with veto power.', isStatic: true },
