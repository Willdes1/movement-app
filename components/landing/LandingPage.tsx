...
.aplp .faq{display:flex;flex-direction:column;gap:13px;max-width:840px}
.aplp .faq .qa{background:var(--surface);border:1px solid var(--border);border-radius:14px;padding:20px 22px}
.aplp .faq .qa h3{font-size:17px;font-weight:750;letter-spacing:-.01em}
.aplp .faq .qa p{margin:9px 0 0;color:var(--text-mid);font-size:14.5px;line-height:1.5}
`

const BODY = `
<script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@type":"Organization","name":"Atlas Prime","legalName":"Atlas Prime Labs LLC","url":"https://atlasprime.app","description":"AI performance training for serious athletes and the coaches who program for them."},{"@type":"WebSite","name":"Atlas Prime","url":"https://atlasprime.app"},{"@type":"SoftwareApplication","name":"Atlas Prime","applicationCategory":"HealthApplication","operatingSystem":"Web, iOS, Android","offers":[{"@type":"Offer","name":"Athlete Free","price":"0","priceCurrency":"USD"},{"@type":"Offer","name":"Athlete Prime","price":"12.99","priceCurrency":"USD"},{"@type":"Offer","name":"Coach Starter","price":"19","priceCurrency":"USD"},{"@type":"Offer","name":"Coach Growth","price":"49","priceCurrency":"USD"},{"@type":"Offer","name":"Coach Pro","price":"99","priceCurrency":"USD"}]},{"@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is Atlas Prime?","acceptedAnswer":{"@type":"Answer","text":"Atlas Prime is an AI performance training platform. It builds a personalized workout plan around your sport, training history, and body, then rebuilds it as you log your work. Coaches get a full portal to program for and manage their athletes."}},{"@type":"Question","name":"How does the AI workout plan work?","acceptedAnswer":{"@type":"Answer","text":"Tell us your sport, experience, and goals. A team of AI specialists drafts a strength and conditioning program, reviews it for safe exercise selection, and tailors it to your sport. Every movement comes with video demos and spoken coaching cues."}},{"@type":"Question","name":"Is there a free plan?","acceptedAnswer":{"@type":"Answer","text":"Yes. Athletes start free with real AI programs, the daily app, demos, set tracking, mobility, and recovery. Coaches start with five AI programs free plus the core coaching portal."}},{"@type":"Question","name":"Can coaches manage clients on Atlas Prime?","acceptedAnswer":{"@type":"Answer","text":"Yes. The coach portal lets you build programs with AI or by hand from your own exercise library, message clients, keep notes, track compliance, and deliver your coaching cues in your own voice."}},{"@type":"Question","name":"What sports does it support?","acceptedAnswer":{"@type":"Answer","text":"Atlas Prime programs for a wide range of sports and for general strength and conditioning, adapting warmups, conditioning, and movement selection to the demands of your sport."}},{"@type":"Question","name":"Does it work on my phone?","acceptedAnswer":{"@type":"Answer","text":"Yes. Atlas Prime runs in any modern mobile or desktop browser, and is being prepared for the App Store and Google Play."}}]}]}</script>
...
<main>
  ...
  <section id="faq" class="path"><div class="wrap">
    <div class="sec-head reveal" style="margin-bottom:28px"><span class="eyebrow">Questions</span><h2 style="margin-top:12px">Good questions, honest answers.</h2></div>
    <div class="faq reveal">
      <div class="qa"><h3>What is Atlas Prime?</h3><p>Atlas Prime is an AI performance training platform. It builds a personalized workout plan around your sport, training history, and body, then rebuilds it as you log your work. Coaches get a full portal to program for and manage their athletes.</p></div>
      <div class="qa"><h3>How does the AI workout plan work?</h3><p>Tell us your sport, experience, and goals. A team of AI specialists drafts a strength and conditioning program, reviews it for safe exercise selection, and tailors it to your sport. Every movement comes with video demos and spoken coaching cues.</p></div>
      <div class="qa"><h3>Is there a free plan?</h3><p>Yes. Athletes start free with real AI programs, the daily app, demos, set tracking, mobility, and recovery. Coaches start with five AI programs free plus the core coaching portal.</p></div>
      <div class="qa"><h3>Can coaches manage clients on Atlas Prime?</h3><p>Yes. The coach portal lets you build programs with AI or by hand from your own exercise library, message clients, keep notes, track compliance, and deliver your coaching cues in your own voice.</p></div>
      <div class="qa"><h3>What sports does it support?</h3><p>Atlas Prime programs for a wide range of sports and for general strength and conditioning, adapting warmups, conditioning, and movement selection to the demands of your sport.</p></div>
      <div class="qa"><h3>Does it work on my phone?</h3><p>Yes. Atlas Prime runs in any modern mobile or desktop browser, and is being prepared for the App Store and Google Play.</p></div>
    </div>
  </div></section>
